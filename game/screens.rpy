...
screen say(who, what):
    ...
    if not renpy.variant("small"):
        add SideImage() at side_small #at side_small fungsi transform untuk mengecilkan ukuran side image
        #xalign 0.0 yalign 1.0 => transform default
    if renpy.variant("small"): #memunculkan side image di mobile
        add SideImage() at side_small_mobile
...
style window:
    ...
    background Image("gui/textbox.png", xalign=0.5, yalign=1.0, ypos=0.95) #ypos posisi vertikal textbox
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ypos 0.97 #posisi vertikal quick menu
            style_prefix "quick"
            style "quick_menu"
